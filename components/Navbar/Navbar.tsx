    ...
    <nav className="w-full bg-white border-b-4 border-blue-900 sticky top-0 z-50 shadow-sm">
      <div className="max-w-350 mx-auto px-6 h-20 flex items-center justify-between">
        <Link href="/" className="flex items-center gap-3 group">
          <div className="p-2 bg-blue-900 rounded-lg text-white group-hover:bg-emerald-500 transition-colors">
            <HiOutlineAcademicCap size={32} />
          </div>
          <div className="leading-tight">
            <h1 className="text-xl font-bold text-blue-900 uppercase">
              Edu<span className="text-emerald-600">Sync</span>
            </h1>
          </div>
        </Link>
        ...
        <div className="flex items-center gap-4">
          ...
          <button className="hidden md:flex items-center gap-2 px-5 py-2.5 bg-emerald-600 text-white text-sm font-bold rounded-md hover:bg-emerald-700 transition-all shadow-md">
