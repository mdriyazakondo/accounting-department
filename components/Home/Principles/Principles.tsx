        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-24 items-center">
          ...
          >
            ...
            <motion.div
              ...
              className="absolute -top-4 -left-4 w-24 h-24 border-t-4 border-l-4 border-emerald-500 z-0"
            ></motion.div>
            ...
            <div className="relative z-10 aspect-[4/5] bg-slate-100 rounded-3xl overflow-hidden shadow-2xl group">
              ...
              <motion.div
                whileHover={{ y: -10 }}
                className="absolute bottom-8 left-8 right-8 bg-white/95 backdrop-blur-md p-8 rounded-2xl shadow-xl border-b-4 border-emerald-500"
              >
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    <p className="text-sm text-emerald-600 font-bold uppercase tracking-widest mt-1">
                      Executive Principal
                    </p>
                  </div>
                  <motion.div
          ...
          <div className="w-full lg:w-1/2 space-y-8">
            ...
            >
              ...
              <div className="flex items-center gap-3 mb-4">
                ...
                <h4 className="text-emerald-600 font-bold uppercase tracking-widest text-xs">
                  Institutional Leadership
                </h4>
              </div>
              <h2 className="text-5xl lg:text-6xl font-black text-blue-900 leading-[1.1] tracking-tighter">
                Fostering <br />
                <span className="text-emerald-500">Academic Purity.</span>
              </h2>
            </motion.div>
