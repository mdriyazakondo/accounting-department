          ...
          >
            ...
            <div className="space-y-6 z-10">
              ...
              <motion.div
                variants={imageVariants}
                whileHover={{ y: -10 }}
                className="h-56 bg-white border-2 border-slate-100 rounded-[2rem] p-8 flex items-center justify-center shadow-xl group transition-colors hover:border-emerald-500"
              >
                <BiBuildingHouse
                  size={70}
                  className="text-blue-900 group-hover:text-emerald-500 transition-colors duration-300"
                />
              </motion.div>
            </div>
            ...
            <div className="space-y-6 pt-16 z-10">
              <motion.div
                variants={imageVariants}
                whileHover={{ y: -10 }}
                className="h-56 bg-emerald-500 rounded-[2rem] p-8 flex items-center justify-center shadow-xl relative overflow-hidden group"
              >
              ...
              >
                <span className="text-5xl font-black mb-3 group-hover:text-emerald-500 transition-colors">
                  150+
                </span>
          ...
          >
            <motion.div variants={itemVariants} className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                <h4 className="text-emerald-600 font-black uppercase tracking-[0.3em] text-xs">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <motion.div
                ...
                className="flex flex-col gap-4 p-8 bg-white rounded-3xl shadow-[0_10px_40px_rgba(0,0,0,0.04)] border border-slate-100 hover:border-emerald-500 transition-all group"
              >
                <div className="w-12 h-12 bg-blue-50 rounded-xl flex items-center justify-center text-blue-900 group-hover:bg-emerald-500 group-hover:text-white transition-colors">
            ...
            >
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="px-10 py-5 bg-blue-900 text-white font-black rounded-full hover:bg-emerald-600 transition-all shadow-xl uppercase text-[10px] tracking-[0.2em]"
              >
                Read Our Story
              </motion.button>
