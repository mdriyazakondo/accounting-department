        ...
        <div className="mb-12 flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            <h2 className="text-3xl font-black text-blue-900 uppercase tracking-tighter">
              Accounting <span className="text-emerald-500">Syllabus</span>
            </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
          {academicYears.map((item, index) => (
            <motion.div
              ...
              whileHover={{ borderColor: "#10b981" }} // Emerald-500
            ...
            >
              <div>
                ...
                {/* Title */}
                <h3 className="text-lg font-bold text-blue-900 mb-6 leading-tight group-hover:text-emerald-600 transition-colors">
                  {item.title} <br />
                  Studies
                </h3>
